...
nel=16;                  % number of elements 12
nnel=4;                  % number of nodes per element
ndof=2;                  % number of dofs per node
nnode=27;                % total number of nodes in system 21
...
%---------------------------------------------
gcoord=xlsread('Data.xlsx',1,'B2:C28');
nodes=xlsread('Data.xlsx',2,'A1:D16');
...
bcdof=[23 24 39 40 1 2];         % first two dofs are constrained
ydiscoor=xlsread('Data.xlsx',3,'B1:B3');           % whose described values are 0 
...
ForceNodes=xlsread('Data.xlsx',3,'A1:A3');
Force1=(1/12)*[2 1;1 2]*[subs(q,y,gcoord(ForceNodes(1),2));subs(q,y,gcoord(ForceNodes(2),2))];
Force2=(1/12)*[2 1;1 2]*[subs(q,y,gcoord(ForceNodes(2),2));subs(q,y,gcoord(ForceNodes(3),2))];
% Force3=(1/18)*[2 1;1 2]*[subs(q,y,gcoord(ForceNodes(3),2));subs(q,y,gcoord(ForceNodes(4),2))];
ForceEqu=[Force1(1),Force1(2)+Force2(1),Force2(2)];
ff(ForceNodes(1:length(ForceNodes))*2)=ForceEqu(1:3);
