...
nel=68;                  % number of elements 125
nnel=4;                  % number of nodes per element
ndof=2;                  % number of dofs per node
nnode=90;                % total number of nodes in system 156
...
%---------------------------------------------
gcoord=xlsread('Data.xlsx',1,'B2:C91');
nodes=xlsread('Data.xlsx',2,'A1:D68');
...
bcdof=[45 46 79 80 81 82 83 84 1 2];         % first two dofs are constrained
ydiscoor=xlsread('Data.xlsx',3,'B1:B5');           % whose described values are 0 
...
ForceNodes=xlsread('Data.xlsx',3,'A1:A5');
Force1=(1/24)*[2 1;1 2]*[subs(q,y,gcoord(ForceNodes(1),2));subs(q,y,gcoord(ForceNodes(2),2))];
Force2=(1/24)*[2 1;1 2]*[subs(q,y,gcoord(ForceNodes(2),2));subs(q,y,gcoord(ForceNodes(3),2))];
Force3=(1/24)*[2 1;1 2]*[subs(q,y,gcoord(ForceNodes(3),2));subs(q,y,gcoord(ForceNodes(4),2))];
Force4=(1/24)*[2 1;1 2]*[subs(q,y,gcoord(ForceNodes(4),2));subs(q,y,gcoord(ForceNodes(5),2))];
ForceEqu=[Force1(1),Force1(2)+Force2(1),Force2(2)+Force3(1),Force3(2)+Force4(1),Force4(2)];
ff(ForceNodes(1:length(ForceNodes))*2)=ForceEqu(1:5);
